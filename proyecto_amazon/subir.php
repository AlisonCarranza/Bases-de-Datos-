...
<body>
    ...
    <div class="container">		
					<form name="form1" id="form1" method="post" action="ajax/procesarIngreso.php" enctype="multipart/form-data">
						<br><br><h4 class="text-center">Cargar imagenes de articulo</h4><br><br>
